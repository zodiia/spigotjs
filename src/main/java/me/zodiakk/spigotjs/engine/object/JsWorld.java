...
public interface JsWorld extends ApiElement {
    ...
    public boolean createExplosion(JsLocation location, boolean setFire);
    public boolean createExplosion(JsLocation location, boolean setFire, boolean breakBlocks);
